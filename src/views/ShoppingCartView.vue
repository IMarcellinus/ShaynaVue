...
export default {
    ...
    checkout(){
        let prodcutIds = this.keranjangUser.map(function (product) {
            return product.id
        });
        ...
        let checkoutData = {
            ...
            "transaction_details": prodcutIds
        }

        axios
            .get("https://shayna-backend.buildwithangga.id/api/products", checkoutData)
