                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs" v-if="productDetails.galleries.length > 0">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false" :autoplay="true">
                                    <div v-for="ss in productDetails.galleries"
                                    :key="ss.id"  class="pt" @click="changeImage(ss.photo)" :class="ss.photo == gambar_default ? 'active' : '' ">
...
export default {
  ...
  components: {
    ...
    methods: {
        ...
        setDataPicture(data){
            // replace object prodcutDetails dengan data dari API
